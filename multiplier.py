...
import numpy
#Takes the dimension of the matrix and filename as input; then parses the matrices A, L, U, Aresidual and Pi vector from it; then calculates the matrix PA-LU and calculates its norm
# It prints the PA - LU matrix and then the norm value on the console. 
